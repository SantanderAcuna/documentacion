...
/**
 * Request de validación para crear contenido
 * 
 * Valida todos los datos de entrada para creación de contenidos.
 * Mensajes de error en español para mejor UX.
 */
final class StoreContenidoRequest extends FormRequest
{
    /**
